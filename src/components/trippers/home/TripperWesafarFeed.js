...
const TripperWesafarFeed = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg p-6 bg-[#222222] shadow-xl">
      {/* Subtle floating gradient layers for a futuristic effect */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-1/3 -left-1/4 w-[70vw] h-[70vw] bg-gradient-to-r from-[#ff009a] to-[#fc6767] opacity-10 rounded-full blur-3xl" />
      ...
      <h2 className="relative z-10 mb-6 bg-gradient-to-r from-[#ff009a] via-[#fc6767] to-[#f84444] bg-clip-text text-4xl font-extrabold text-transparent drop-shadow-[0_0_5px_rgba(0,255,255,0.5)]">
        Community Feed
      </h2>
...
export default TripperWesafarFeed;
