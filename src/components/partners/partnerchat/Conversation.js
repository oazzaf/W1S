    ...
    <div className="p-3 flex flex-col h-full justify-between bg-gradient-to-b from-[#131313] to-[#1f1f23]">
          ...
          >
            <div
              className={`rounded-lg p-3 text-sm shadow-lg max-w-[70%] ${
                message.sent
                  ? 'bg-gradient-to-r from-[#a158ef] via-[#e34cf4] to-[#4890f4] text-white'
      ...
      <div className="flex items-center bg-[#2a2a2e] p-2 rounded-full shadow-md relative">
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#a158ef] via-[#e34cf4] to-[#4890f4] p-3 rounded-full text-white shadow-md absolute right-2 hover:scale-105 transition-all"
        >
          <MdSend size={20} />
        </button>
      </div>
